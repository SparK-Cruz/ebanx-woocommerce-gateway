...
The EBANX Gateway Plugin can also be installed using GitHub. You can find our repository [here](https://github.com/ebanx/ebanx-woocommerce-gateway/ "EBANX GitHub repository"). To download the plugin from our repository, please view [our latest release](https://github.com/ebanx/ebanx-woocommerce-gateway/releases/latest "Latest Release from GitHub repository") and download the `ebanx-woocommerce-gateway.zip` package.
